...
function NotificaDipendente() {
  ...
  async function getProfile() {
    ...
    let response = fetch("https://alpakas.herokuapp.com/getdipendente", {
      method: "post",
      headers: {
  ...
  async function disoccupaDipendente() {
    ...
    let d = JSON.parse(localStorage.getItem("profile"));
    let response = await fetch("https://alpakas.herokuapp.com/liberadipendente", {
      method: "post",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
