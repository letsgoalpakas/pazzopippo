...
const Incarichi = () => {
    ...
    async function getIncarichi() {
        let response = await fetch("https://alpakas.herokuapp.com/getIncarichi", {
            method: "get",
            headers: {
  ...
  async function setOccupato(n){
        ...
        let response = await fetch("https://alpakas.herokuapp.com/dipendenteoccupato",{
                method: "post",
                headers: {
                  'Accept': 'application/json',
                  'Content-Type': 'application/json',
    ...
    async function getAssistenza(n){
        ...
        let dipendente = JSON.parse(localStorage.getItem("profile"));
        let response = await fetch("https://alpakas.herokuapp.com/assistenteoccupato",{
                method: "post",
                headers: {
                  'Accept': 'application/json',
                  'Content-Type': 'application/json',
